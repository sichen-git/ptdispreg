...
for(j in 1:length(a.uniq)){
  ...
  diffll_n2=(values_n2[,15]-values_mom[,15])<0.000001
  diffll_n1=(values_n1[,15]-values_mom[,15])<0.000001
  diffll_0=(values_0[,15]-values_mom[,15])<0.000001
  diffll_05=(values_05[,15]-values_mom[,15])<0.000001
