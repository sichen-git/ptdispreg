...
for(j in a){
  for(i in 1:1000){
    ...
    # write to file
    write.table(param.tmp, file="one_cov_mom.csv",
    ...
    param.tmp=matrix(c(i, j, model.disp.tmp$estimate, se.tmp, model.disp.tmp$minimum, model.disp.tmp$code,hesspd.tmp), nrow=1)   
    # write to file
    write.table(param.tmp, file="one_cov_inian2.csv",
                append = TRUE, sep = ",", row.names = FALSE, col.names = FALSE)
    ...
    # collect results
      param.tmp=matrix(c(i, j, model.disp.tmp$estimate, se.tmp, model.disp.tmp$minimum, model.disp.tmp$code,hesspd.tmp), nrow=1)   
    # write to file
    write.table(param.tmp, file="one_cov_inian1.csv",
                append = TRUE, sep = ",", row.names = FALSE, col.names = FALSE)
    ...
    # collect results
      param.tmp=matrix(c(i, j, model.disp.tmp$estimate, se.tmp, model.disp.tmp$minimum, model.disp.tmp$code,hesspd.tmp), nrow=1)   
    # write to file
    write.table(param.tmp, file="one_cov_inia0.csv",
                append = TRUE, sep = ",", row.names = FALSE, col.names = FALSE)
    ...
    param.tmp=matrix(c(i, j, model.disp.tmp$estimate, se.tmp, model.disp.tmp$minimum, model.disp.tmp$code,hesspd.tmp), nrow=1)   
    # write to file
    write.table(param.tmp, file="one_cov_inia05.csv",
                append = TRUE, sep = ",", row.names = FALSE, col.names = FALSE)
  }
